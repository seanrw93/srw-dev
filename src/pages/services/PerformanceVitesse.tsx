        ...
        <div className="about-inner">
          <Reveal>
            <div>
              ...
              <p className="about-body">
                L'optimisation couvre l'ensemble de la chaîne : compression et conversion des images, mise en cache intelligente, suppression du code inutile, chargement différé des ressources non critiques. Votre site devient rapide dès la première visite et mieux positionné sur Google.
              </p>
              <p className="about-body">
                À la fin de l'intervention, vous recevez un rapport détaillé avec les actions effectuées, les scores Lighthouse avant et après, et les recommandations pour maintenir ces performances dans la durée. Les résultats sont mesurables et documentés.
              </p>
            </div>
          </Reveal>
